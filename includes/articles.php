        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="single-blog">
                    <img src="images/blog/GroupeSimplonIness.jpg" alt="Groupe Simplon Iness" />
                    <h3>Titre 1</h3>
                    <ul class="post-meta">
            ...
            <div class="col-sm-4">
                <div class="single-blog">
                    <img src="images/blog/Simplon_HourOfCode.jpg" alt="Simplon Hour Of Code" />
                    <h3>Titre 2</h3>
                    <ul class="post-meta">
                        <li><i class="fa fa-pencil-square-o"></i><strong> Posted By:</strong> John</li>
                        <li><i class="fa fa-clock-o"></i><strong> Posted On:</strong> Apr 15 2014</li>
            ...
            <div class="col-sm-4">
                <div class="single-blog">
                    <img src="images/blog/Finformation.jpg" alt="Fin Formation.jpg" />
                    <h3>Titre 3</h3>
                    <ul class="post-meta">
                        <li><i class="fa fa-pencil-square-o"></i><strong> Posted By:</strong> John</li>
                        <li><i class="fa fa-clock-o"></i><strong> Posted On:</strong> Apr 15 2014</li>
